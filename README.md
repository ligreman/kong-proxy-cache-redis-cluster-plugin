...
|`config.redis_cluster_name`| string            |*required*| myRedisCluster                                                        | Internal name of the cluster (can be anyone).                                                                                                                                                                                                                                                                         |
|`config.redis_cluster_nodes_hosts_ports`| array             |*required*|                                                                       | List of nodes of the Redis Cluster. It is a list of strings, each one containing the `host:ip` of each node. Example: `10.10.10.10:6379, 20.20.20.20:6380, 30.30.30.30:6381`.                                                                                                                                         |
|`config.redis_cluster_password`| string            |*optional*|                                                                       | The password (if required) to authenticate to the redis server.                                                                                                                                                                                                                                                       |
|`config.redis_cluster_connect_timeout`| integer           |*optional*| 1000                                                                  | The timeout in milliseconds for the redis connection.                                                                                                                                                                                                                                                                 |
|`config.redis_cluster_keepalive_timeout`| integer           |*optional*| 60000                                                                 | The timeout in milliseconds for the keepalive of the connections pool.                                                                                                                                                                                                                                                |
|`config.redis_cluster_connection_pool_size`| integer           |*optional*| 1000                                                                  | Size of the pool, for the keepalive connections function (not for the connection pool).                                                                                                                                                                                                                               |
|`config.redis_cluster_max_redirection`| integer           |*optional*| 16                                                                    | Max number of redirections to follow (when receiving MOVED or ASK from Redis cluster).                                                                                                                                                                                                                                |
|`config.redis_cluster_max_connection_attempts`| integer           |*optional*| 3                                                                     | Size of the pool, for the keepalive connections function (not for the connection pool).                                                                                                                                                                                                                               |
|`config.redis_cluster_use_ssl_connection`| boolean           |*optional*| false                                                                 | Set this to `true`, when connecting to a Redis Cluster with TLS enabled.                                                                                                                                                                                                                                           |
